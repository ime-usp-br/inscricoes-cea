...
class NotifyAboutConsultationMeetingDecisionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_email_with_paid_fee_has_no_attachment_and_shows_exemption()
    {
        $mailTemplate = MailTemplate::factory()->create([
            ...
            'active' => true,
            'subject' => 'Resultado da Reunião de Consulta',
        ...
        $consultation = ConsultationMeeting::factory()->create(['applicationID' => $app->id]);

        $mailable = new NotifyAboutConsultationMeetingDecision($consultation, $mailTemplate);
        $mailable->build();
