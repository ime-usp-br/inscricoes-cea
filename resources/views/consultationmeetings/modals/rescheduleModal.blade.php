   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Reagendar Reunião de Consulta</h4>
            </div>
            <form id="rescheduleConsultationMeetingForm" method="POST"
                ...
                <div class="row custom-form-group align-items-center">
                    ...
                    <div class="col-12 col-md-7" style="white-space: nowrap;">
                        <input class="custom-form-control custom-datepicker" style="max-width:200px;"
                            type="text" name="date" id="date" autocomplete="off"
                        />
                    </div>
                </div>
                <div class="row custom-form-group align-items-center">
            ...
            <div class="modal-footer">
                <button id="btn-rescheduleConsultationMeeting" class="btn btn-default" type="submit">Reagendar</button>
