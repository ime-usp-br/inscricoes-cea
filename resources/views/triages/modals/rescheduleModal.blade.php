   ...
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Reagendar Triagem</h4>
            </div>
            <form id="rescheduleTriageForm" method="POST"
            ...
            <div class="modal-footer">
                <button id="btn-rescheduleTriage" class="btn btn-default" type="submit">Reagendar</button>
