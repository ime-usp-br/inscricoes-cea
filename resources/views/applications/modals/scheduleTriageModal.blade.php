<div class="modal fade" id="scheduleTriageModal">
   <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Agendar Triagem</h4>
            </div>
            <form id="scheduleTriageForm" method="POST"
            ...
            <div class="modal-footer">
                <button id="btn-scheduleTriage" class="btn btn-default" type="submit">Agendar</button>
